...
const searchSchema = z.object({
  ...
  step:            z.coerce.number().min(0).max(8).optional(),
})
...
// connect step is index 3 in the STEPS array (welcome/portfolio/resume/connect/repos/processing/mirror/distill/review)
