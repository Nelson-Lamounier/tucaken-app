...
const PROJECTS_V2_ENABLED = import.meta.env.VITE_PROJECTS_V2 === 'true'
...
function ProjectsPage() {
  return (
    ...
    >
      {PROJECTS_V2_ENABLED ? <ProjectsIndex /> : <ProjectsPlaceholder />}
    </DashboardPage>
  )
}
...
function ProjectsPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-24 text-center">
      <div className="grid size-16 place-items-center rounded-2xl bg-white/2 inset-ring inset-ring-white/10">
      ...
      <div className="max-w-sm space-y-2">
        ...
        <p className="text-sm leading-relaxed text-zinc-500">
          Projects will surface your GitHub repos as structured portfolio entries — linked to the
          skills and technologies Tucaken extracts from your commits and PRs.
        </p>
      </div>
