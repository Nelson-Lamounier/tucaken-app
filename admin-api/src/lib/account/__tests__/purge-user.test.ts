...
jest.unstable_mockModule('../../github/github-uninstall.js', () => ({
  revokeGitHubInstallationForUser: revokeMock,
}))
jest.unstable_mockModule('../../account/cognito-admin.js', () => ({
...
const { purgeUser } = await import('../../account/purge-user.js')
