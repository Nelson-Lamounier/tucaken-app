/** @format */
import { ENTITLEMENTS, isFullAccess, entitlementsFor, enrichmentEnv, analysisModeFor } from '../../billing/entitlements.js';
...
import { entitlementsFromConfig } from '../../billing/entitlements.js';
