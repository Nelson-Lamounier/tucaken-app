...
jest.unstable_mockModule('../../../lib/github/github-app.js', () => ({
...
import { DEFAULT_TIER_CONFIG } from '../../../lib/billing/tier-config-shape.js';

jest.unstable_mockModule('../../../lib/billing/tier-config-cache.js', () => ({
...
const { createGitHubRouter, createGitHubWebhookRouter } = await import('../../github/github.js');
...
// Shared reset across all suites in this file; intentional file-level hook.
beforeEach(() => {
    jest.clearAllMocks();
    poolQueryMock.mockResolvedValue({ rows: [] });
